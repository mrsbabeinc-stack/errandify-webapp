...
router.get('/campaigns', isAuthenticated, async (req: any, res: Response) => {
  try {
...
router.put('/campaigns/:id', isAuthenticated, async (req: any, res: Response) => {
  try {
    const { id } = req.params;
...
router.delete('/campaigns/:id', isAuthenticated, async (req: any, res: Response) => {
  try {
    const { id } = req.params;
...
router.get('/campaigns/:id/performance', isAuthenticated, async (req: any, res: Response) => {
  try {
    const { id } = req.params;
...
router.post('/suggestions', isAuthenticated, async (req: any, res: Response) => {
  try {
...
router.post('/campaigns/:id/pause', isAuthenticated, async (req: any, res: Response) => {
  try {
    const { id } = req.params;
    const campaign = await campaignModel.getById(parseInt(id));
    if (!campaign) {
...
router.post('/campaigns/:id/resume', isAuthenticated, async (req: any, res: Response) => {
  try {
    const { id } = req.params;
    const campaign = await campaignModel.getById(parseInt(id));
    if (!campaign) {
