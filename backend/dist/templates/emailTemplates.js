...
export function templateBidAccepted(doerName, taskTitle, amount, taskId) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
export function templateTaskReopened(doerName, taskTitle, bidAmount, taskId) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
export function templatePaymentReleased(doerName, amount, taskTitle) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
export function templateDailyDigest(userName, summary) {
    const bidsList = (summary.bids || [])
        .map((bid) => `<li>${bid.doer} bid $${bid.amount} on "${bid.task}"</li>`)
        .join('');
    const messagesList = (summary.messages || [])
        .map((msg) => `<li>From ${msg.sender}: "${msg.preview}"</li>`)
        .join('');
    return `
    <!DOCTYPE html>
    <html>
...
export function templateEventReminder7Days(userName, eventTitle, eventDate, eventTime, eventLocation, eventLink, agenda, preparation) {
...
export function templateEventReminder24Hours(userName, eventTitle, eventDate, eventTime, eventLocation, eventLink, agenda, preparation) {
    const agendaHtml = agenda && agenda.length > 0
        ? `
      <div style="background-color: #f0f8ff; padding: 15px; border-radius: 8px; margin: 15px 0;">
...
export function templateEventReminder1Hour(userName, eventTitle, eventTime, eventLocation, eventLink) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
export function templateEventReminderDayOf(userName, eventTitle, eventDate, eventTime, eventLocation, eventLink, agenda) {
    const agendaHtml = agenda && agenda.length > 0
        ? `
      <div style="background-color: #f0f8ff; padding: 15px; border-radius: 8px; margin: 15px 0;">
...
export function templateEventConfirmation(userName, eventTitle, eventDate, eventTime, eventLocation, eventDescription) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
export function templatePaymentReminder(userName, taskTitle, hoursLeft) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
export function templateReferralJoin(referrerName, newUserName, pointsAwarded) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
export function templateFirstJobBonus(referrerName, newUserName, pointsAwarded) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
...
export function templateRatingReceived(doerName, raterName, rating, taskTitle, pointsAwarded) {
...
export function templateRatingReminder(doerName, askerName, taskTitle, taskId) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
