...
router.post('/mock-create-intent', authMiddleware, async (req, res) => {
    try {
...
router.post('/mock-confirm-payment', authMiddleware, async (req, res) => {
    try {
...
router.post('/mock-refund', authMiddleware, async (req, res) => {
    try {
...
router.post('/mock-create-account', authMiddleware, async (req, res) => {
    try {
...
router.post('/mock-payout', authMiddleware, async (req, res) => {
    try {
...
router.get('/mock-intent/:intentId', authMiddleware, async (req, res) => {
    try {
