...
async function sendViaMailgun(to, subject, html, text) {
    try {
        ...
        const response = await fetch(`https://api.mailgun.net/v3/${config.email.mailgunDomain}/messages`, {
            method: 'POST',
...
async function sendViaMailgunSimple(to, subject, html, text) {
    try {
        const response = await fetch(`https://api.mailgun.net/v3/${config.email.mailgunDomain}/messages`, {
            method: 'POST',
            headers: {
...
export async function sendDisputeRaisedEmail(toEmail, userName, errandTitle, issueType, disputeId) {
...
export async function sendDisputeResolvedEmail(toEmail, userName, errandTitle, decision, decisionMessage, disputeId) {
...
export async function sendDisputeDecisionEmail(toEmail, userName, errandTitle, budget, userRole, decision, disputeId) {
    const verdictEmoji = {
