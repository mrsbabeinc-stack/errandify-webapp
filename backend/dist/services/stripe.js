...
export const stripeService = {
     ...
     */
    async createPaymentIntent(amount, taskId, doerId) {
        try {
     ...
     */
    async createConnectedAccount(doerId, email, name) {
        try {
     ...
     */
    async createTransfer(amount, destinationAccountId, taskId, reason) {
        try {
     ...
     */
    async createPayout(stripeAccountId, amount, taskId) {
        try {
     ...
     */
    async getPayoutStatus(stripeAccountId, payoutId) {
        try {
     ...
     */
    async createAccountLink(stripeAccountId, returnUrl) {
        try {
     ...
     */
    async setDefaultPayoutAccount(stripeAccountId, externalAccountId) {
        try {
     ...
     */
    async getBankAccountDetails(stripeAccountId, externalAccountId) {
        try {
            const bankAccount = await stripe.accounts.retrieveExternalAccount(stripeAccountId, externalAccountId);
            return {
                id: bankAccount.id,
