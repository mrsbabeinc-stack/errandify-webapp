...
async function seedBlogArticles() {
    try {
        ...
        for (const article of blogArticles) {
            await db.query(`INSERT INTO blog_posts (slug, title, subtitle, excerpt, content, featured_image_url, category, author, published_at, read_time_minutes, seo_keywords, seo_meta_description, is_published)
