...
export const COMPREHENSIVE_FAQ: FAQItem[] = [
  ...
  // BIDDING & ACCEPTING (6)
  {
    ...
    question: { en: 'How does bidding work on Errandify?', zh: '在帮帮乐上出价是如何运作的？' },
    answer: { en: 'Bidding is how doers show interest in your errand!\n\n1. You post an errand with details and budget\n2. Doers see your errand and place a bid\n3. You review all bids, profiles, and ratings\n4. You choose your preferred doer by accepting their bid\n5. Work begins - you coordinate and complete the task\n6. Payment happens once work is approved\n\nYou\'re in control! You only pay when happy with the work. 💼', zh: '出价是帮手表示对你的帮帮感兴趣的方式！流程如下：\n\n1. 你发布一个有详细信息和预算的帮帮\n2. 帮手看到你的帮帮并可以出价\n3. 你审查所有出价、帮手档案和评级\n4. 你选择你首选的帮手来接受他们的出价\n5. 工作开始 - 你和你的帮手协调并完成任务\n6. 支付发生 一旦工作被批准\n\n你掌握权力！你只有在满意工作时才会支付。💼' },
