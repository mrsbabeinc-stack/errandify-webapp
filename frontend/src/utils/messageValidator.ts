...
export const validateMessage = (content: string): ValidationResult => {
  ...
  const suggestiveContext = /\bzzz\b.*\btogether\b|\bcome\b.*\bover\b|\byour\b.*\bplace\b|\bmy\b.*\bplace\b|\bone\b.*\bnight\b.*\bstand\b|\bdtf\b|\bblow\b.*\bsomeone\b|\bblow\b.*\bme\b|\blick\b.*\bme\b|\blick\b.*\bsomeone\b|\beat\b.*\bme\b|\beat\b.*\bsomeone\b|\bsuck\b.*\bme\b|\bsuck\b.*\bsomeone\b/i.test(cleanedPhrase);
