...
export default function CreateErrandPage() {
  ...
  // Singapore postal code to area and full address mapping (first 2 digits)
  const postalCodeAreas: Record<string, { area: string; address: string }> = {
    '01': { area: 'Raffles Place', address: '1 Raffles Place, Singapore 048616' },
    '02': { area: 'Cecil Street', address: 'Cecil Street, Singapore 069421' },
    '03': { area: 'Tanjong Pagar', address: 'Tanjong Pagar, Singapore 088495' },
    '04': { area: 'Tanjong Pagar', address: 'Tanjong Pagar, Singapore 088495' },
    '05': { area: 'Outram', address: 'Outram Road, Singapore 169040' },
    '06': { area: 'People\'s Park', address: 'People\'s Park Centre, Singapore 059206' },
    '07': { area: 'Chinatown', address: 'Chinatown, Singapore 058837' },
    '08': { area: 'Tanjong Pagar', address: 'Tanjong Pagar, Singapore 088495' },
    '09': { area: 'Tanjong Pagar', address: 'Tanjong Pagar, Singapore 088495' },
    '10': { area: 'Orchard', address: 'Orchard Road, Singapore 238835' },
    '11': { area: 'Orchard', address: 'Orchard Road, Singapore 238835' },
    '12': { area: 'Novena', address: 'Novena, Singapore 309268' },
    '13': { area: 'Newton', address: 'Newton Road, Singapore 309264' },
    '14': { area: 'Farrer Park', address: 'Farrer Park, Singapore 269160' },
    '15': { area: 'Serangoon', address: 'Serangoon Road, Singapore 367942' },
    '16': { area: 'Serangoon', address: 'Serangoon Road, Singapore 367942' },
    '17': { area: 'Serangoon', address: 'Serangoon Road, Singapore 367942' },
    '18': { area: 'Macpherson', address: 'Macpherson Road, Singapore 368185' },
    '19': { area: 'Paya Lebar', address: 'Paya Lebar, Singapore 409051' },
    '20': { area: 'Paya Lebar', address: 'Paya Lebar, Singapore 409051' },
    '21': { area: 'Geylang', address: 'Geylang Road, Singapore 389105' },
    '22': { area: 'Geylang', address: 'Geylang Road, Singapore 389105' },
    '23': { area: 'Geylang', address: 'Geylang Road, Singapore 389105' },
    '24': { area: 'Eunos', address: 'Eunos Road, Singapore 400018' },
    '25': { area: 'Bedok', address: 'Bedok, Singapore 469251' },
    '26': { area: 'Bedok', address: 'Bedok, Singapore 469251' },
    '27': { area: 'Bedok', address: 'Bedok, Singapore 469251' },
    '28': { area: 'Tampines', address: 'Tampines, Singapore 529203' },
    '29': { area: 'Tampines', address: 'Tampines, Singapore 529203' },
    '30': { area: 'Tampines', address: 'Tampines, Singapore 529203' },
    '31': { area: 'Pasir Ris', address: 'Pasir Ris, Singapore 519645' },
    '32': { area: 'Pasir Ris', address: 'Pasir Ris, Singapore 519645' },
    '33': { area: 'Punggol', address: 'Punggol, Singapore 828861' },
    '34': { area: 'Punggol', address: 'Punggol, Singapore 828861' },
    '35': { area: 'Hougang', address: 'Hougang, Singapore 530721' },
    '36': { area: 'Hougang', address: 'Hougang, Singapore 530721' },
    '37': { area: 'Sengkang', address: 'Sengkang, Singapore 544535' },
    '38': { area: 'Sengkang', address: 'Sengkang, Singapore 544535' },
    '39': { area: 'Sengkang', address: 'Sengkang, Singapore 544535' },
    '40': { area: 'Jurong West', address: 'Jurong West, Singapore 649204' },
    '41': { area: 'Jurong West', address: 'Jurong West, Singapore 649204' },
    '42': { area: 'Jurong', address: 'Jurong, Singapore 629744' },
    '43': { area: 'Jurong East', address: 'Jurong East, Singapore 609628' },
    '44': { area: 'Clementi', address: 'Clementi, Singapore 129958' },
    '45': { area: 'Clementi', address: 'Clementi, Singapore 129958' },
    '46': { area: 'Clementi', address: 'Clementi, Singapore 129958' },
    '47': { area: 'Bukit Merah', address: 'Bukit Merah, Singapore 159058' },
    '48': { area: 'Bukit Merah', address: 'Bukit Merah, Singapore 159058' },
    '49': { area: 'Tiong Bahru', address: 'Tiong Bahru, Singapore 160100' },
    '50': { area: 'Redhill', address: 'Redhill, Singapore 161261' },
    '51': { area: 'Queenstown', address: 'Queenstown, Singapore 149090' },
    '52': { area: 'Commonwealth', address: 'Commonwealth, Singapore 139563' },
    '53': { area: 'Pasir Panjang', address: 'Pasir Panjang, Singapore 118523' },
    '54': { area: 'Pasir Panjang', address: 'Pasir Panjang, Singapore 118523' },
    '55': { area: 'Bukit Timah', address: 'Bukit Timah, Singapore 269108' },
    '56': { area: 'Bukit Timah', address: 'Bukit Timah, Singapore 269108' },
    '57': { area: 'Holland', address: 'Holland, Singapore 278995' },
    '58': { area: 'Tanglin', address: 'Tanglin, Singapore 247922' },
    '59': { area: 'Clementi', address: 'Clementi, Singapore 129958' },
    '60': { area: 'Bukit Timah', address: 'Bukit Timah, Singapore 269108' },
    '61': { area: 'Bishan', address: 'Bishan, Singapore 579874' },
    '62': { area: 'Bishan', address: 'Bishan, Singapore 579874' },
    '63': { area: 'Serangoon', address: 'Serangoon Road, Singapore 367942' },
    '64': { area: 'Serangoon', address: 'Serangoon Road, Singapore 367942' },
    '65': { area: 'Serangoon', address: 'Serangoon Road, Singapore 367942' },
    '66': { area: 'Serangoon', address: 'Serangoon Road, Singapore 367942' },
    '67': { area: 'Aljunied', address: 'Aljunied, Singapore 389986' },
    '68': { area: 'Aljunied', address: 'Aljunied, Singapore 389986' },
    '69': { area: 'Geylang', address: 'Geylang Road, Singapore 389105' },
    '70': { area: 'Bedok', address: 'Bedok, Singapore 469251' },
    '71': { area: 'Bedok', address: 'Bedok, Singapore 469251' },
    '72': { area: 'Bedok', address: 'Bedok, Singapore 469251' },
    '73': { area: 'Bedok', address: 'Bedok, Singapore 469251' },
    '74': { area: 'Tampines', address: 'Tampines, Singapore 529203' },
    '75': { area: 'Tampines', address: 'Tampines, Singapore 529203' },
    '76': { area: 'Tampines', address: 'Tampines, Singapore 529203' },
    '77': { area: 'Tampines', address: 'Tampines, Singapore 529203' },
    '78': { area: 'Tampines', address: 'Tampines, Singapore 529203' },
    '79': { area: 'Sengkang', address: 'Sengkang, Singapore 544535' },
    '80': { area: 'Sengkang', address: 'Sengkang, Singapore 544535' },
    '81': { area: 'Sengkang', address: 'Sengkang, Singapore 544535' },
    '82': { area: 'Sengkang', address: 'Sengkang, Singapore 544535' },
  };
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (code.length === 6 && /^\d+$/.test(code)) {
                      // Get area and full address from postal code (first 2 digits)
                      const areaPrefix = code.substring(0, 2);
                      const areaData = postalCodeAreas[areaPrefix];
                      const area = areaData?.area || 'Singapore';
                      const fullAddressBase = areaData?.address || `Singapore ${code}`;

                      // Store: area (shown to public) and full address (shown only to doer)
                      setFormData((prev) => ({
                        ...prev,
                        location: area,
                      }));

                      // Auto-fill full address field
                      setFullAddress(`${fullAddressBase}, Unit: [Block/Unit number], Singapore ${code}`);
