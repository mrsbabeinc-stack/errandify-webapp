...
export default function CreateErrandPage() {
  ...
  const postalCodeAreas: Record<string, { area: string; building: string }> = {
    ...
    '15': { area: 'Serangoon', building: 'Serangoon Central' },
    '16': { area: 'Serangoon', building: 'Serangoon Central' },
    '17': { area: 'Serangoon', building: 'Serangoon Central' },
    ...
    '63': { area: 'Serangoon', building: 'Serangoon Central' },
    '64': { area: 'Serangoon', building: 'Serangoon Central' },
    '65': { area: 'Serangoon', building: 'Serangoon Central' },
    '66': { area: 'Serangoon', building: 'Serangoon Central' },
    '67': { area: 'Aljunied', building: 'Aljunied' },
    '68': { area: 'Aljunied', building: 'Aljunied' },
