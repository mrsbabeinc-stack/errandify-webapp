  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 z-50 flex items-end justify-center p-0">
      ...
      <div className="bg-white rounded-t-3xl shadow-2xl w-full h-[95vh] max-w-2xl flex flex-col overflow-hidden">
        ...
        {/* Main Content - Hana Left + Chat Right Layout */}
        <div className="flex-1 overflow-y-auto flex gap-4 px-6 py-6">
          {/* Left Side - Hana Avatar */}
          <div className="flex-shrink-0 flex items-start justify-center">
            <div style={{ height: '350px', width: 'auto', maxWidth: '220px' }}>
              <HanaAnimatedAvatar
          ...
          {/* Right Side - Chat (Speech Bubble + Growing Space + Input) */}
